...
class Send_System_Info_Plugin {
	...
	static function enqueue_js() {
		wp_register_script( 'ssi-script', plugins_url( '/ui/send-system-info.js', __FILE__ ), array( 'jquery'), SSI_VERSION, false );
	...
	static function enqueue_css() {
		wp_enqueue_style( 'ssi-style', plugins_url( '/ui/send-system-info.css', __FILE__ ), array(), SSI_VERSION  );
	}
